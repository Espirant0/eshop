...
<div class="auth_container">
	...
	<div class="form_container">
		<form action="/admin_panel/<?=$tableName?>/add" method="post" enctype="multipart/form-data" class="auth_form">
			...
			<label>
				<input type="number" name="speed" class="login_input auth_input" placeholder="Введите количество скоростей" required>
			</label>
